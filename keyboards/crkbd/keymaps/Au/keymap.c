...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_split_3x6_3(
    DF(1), KC_Q, KC_W, KC_E, KC_R, KC_T,  KC_Y, KC_U, KC_I, KC_O, KC_P, LGUI(LSFT(KC_S)),
    ...
    LT(6,KC_ESC), LT(2,KC_BSPC), LT(7,KC_VOLD),  LT(7,KC_VOLU), LT(4,KC_SPC), LT(5,KC_TAB)
  ),
  [1] = LAYOUT_split_3x6_3(
    DF(0), KC_Q, KC_W, KC_E, KC_R, KC_T,  KC_Y, KC_U, KC_I, KC_O, KC_P, LCTL(LGUI(LSFT(KC_4))),
    KC_NO, LCTL_T(KC_A), LALT_T(KC_S), LGUI_T(KC_D), LSFT_T(KC_F), KC_G,  KC_H, RSFT_T(KC_J), RGUI_T(KC_K), RALT_T(KC_L), RCTL_T(KC_SCLN), KC_NO,
    KC_NO, KC_Z, KC_X, KC_C, KC_V, KC_B,  KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_NO,

    LT(6,KC_ESC), LT(3,KC_BSPC), LT(7,KC_VOLD),  LT(7,KC_VOLU), LT(4,KC_SPC), LT(5,KC_TAB)
  ),
  [2] = LAYOUT_split_3x6_3(
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,  LCTL(LSFT(KC_TAB)), LALT(KC_ESC), RCS(KC_J), LCTL(KC_TAB), LCTL(KC_LBRC), KC_DEL,
  ...
  [3] = LAYOUT_split_3x6_3(
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,  LCTL(LSFT(KC_TAB)), LGUI(KC_GRV), LGUI(LALT(KC_J)), LCTL(KC_TAB), LGUI(KC_LBRC), KC_DEL,
    KC_NO, KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, KC_NO,  KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, LGUI(KC_RBRC), KC_NO,
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,  KC_P7, KC_P3, KC_P9, KC_P1, KC_CAPS, KC_NO,
  ...
  [6] = LAYOUT_split_3x6_3(
    ...
    KC_NO, KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, KC_NO,  KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_ACL0, KC_NO,
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,  KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, KC_ACL1, KC_NO,

    KC_NO, KC_NO, KC_NO,  KC_BTN3, KC_BTN1, KC_BTN2
  ),
  [7] = LAYOUT_split_3x6_3(
    KC_NO, KC_NO, KC_F7, KC_F8, KC_F9, KC_F10,  DF(0), KC_NO, KC_NO, KC_NO, DF(1), KC_NO,
